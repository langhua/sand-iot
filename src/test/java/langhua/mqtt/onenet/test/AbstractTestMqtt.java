...
public abstract class AbstractTestMqtt extends TestCase {
    ...
    protected void tearDownTcpDevices(String MODULE) throws Exception {
        ...
        if (group1_device1_tcp_thread != null && !group1_device1_tcp_thread.isInterrupted()) {
            group1_device1_tcp_thread.interrupt();
        }
        if (group1_device2_tcp_thread != null && !group1_device2_tcp_thread.isInterrupted()) {
            group1_device2_tcp_thread.interrupt();
        }
        if (group2_device1_tcp_thread != null && !group2_device1_tcp_thread.isInterrupted()) {
            group2_device1_tcp_thread.interrupt();
        }
        if (group2_device2_tcp_thread != null && !group2_device2_tcp_thread.isInterrupted()) {
    ...
    protected void tearDownSslDevices(String MODULE) throws Exception {
        ...
        if (group1_device1_ssl_thread != null && group1_device1_ssl_thread.isInterrupted()) {
            group1_device1_ssl_thread.interrupt();
        }
        if (group1_device2_ssl_thread != null && group1_device2_ssl_thread.isInterrupted()) {
            group1_device2_ssl_thread.interrupt();
        }
        if (group2_device1_ssl_thread != null && group2_device1_ssl_thread.isInterrupted()) {
            group2_device1_ssl_thread.interrupt();
        }
        if (group2_device2_ssl_thread != null && group2_device2_ssl_thread.isInterrupted()) {
